...
<template>
  <main class="pt-20">
    ...
    <div class="ten-percent pt-14 pb-14 primary-bg">
      <h3 class="pb-2 text-2xl">Find your Dutch tutor online</h3>
...
.cards-container {
  display: flex;
  flex-wrap: wrap;
  justify-content: space-between; /* This will evenly space the cards in a row */
}
